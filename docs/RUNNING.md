...
gatk BaseRecalibrator -R genomes/GRCh38.p12.fa --known-sites genomes/dbSNP.b151.vcf \
  -I DAxxx_Processed.out.bam -O DAxxx.recal.table
gatk ApplyBQSR -R genomes/GRCh38.p12.fa \
  -I DAxxx_Processed.out.bam --bqsr-recal-file DAxxx.recal.table -O DAxxx.recal.bam

# Prepare BAM for GATK
gatk AddOrReplaceReadGroups -LB lib -PL illumina -PU unit \
  -SM DAxxx -I DAxxx.recal.bam -O DAxxx.bam
